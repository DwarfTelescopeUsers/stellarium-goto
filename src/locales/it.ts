...
const translations = {
  ...
  pAboutDataCreditConstellationData: "I dati sulle costellazioni provengono da ",
  ...
  pAboutAdditionalRSSData: "Il feed RSS per gli oggetti del cielo profondo è fornito da ",
 ...
 cGoToStellariumPickObject: "Puoi utilizzare Stellarium per aiutarti a scegliere gli oggetti.",
